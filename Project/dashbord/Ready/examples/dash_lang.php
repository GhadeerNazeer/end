<?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $inser = "INSERT INTO lang ( lang_name ,lang_desc ,val) VALUES ( '$lang_name', '$lang_desc' ,'$lang_val' )";
									...
									<div class="card-body">
										<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']).'?id=664544';?>" method="POST" id="my-form">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="email" name="lang_name" >
											</div>
											<div class="form-group">
												<label for="lang_desc">description of language</label>
												<input type="text"  class="form-control" name="lang_desc" id="password"  >
											</div>
											<div class="form-group">
												<label for="lang_val">evaluate of language</label>
												<input type="number" max="5" class="form-control" name="lang_val" id="password"  >
											</div>
